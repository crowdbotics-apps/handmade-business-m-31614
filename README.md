...
## Project Structure
    ...
    ├── handmade_business_m_31614  # Django project configurations
...
1. Clone this repo and `cd handmade_business_m_31614`
...
2. Clone this repo and `cd handmade_business_m_31614`
